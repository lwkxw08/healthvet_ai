    ...
    <div className="bg-slate-800/80 rounded-xl border border-slate-700 p-6">
      ...
      <div className="mb-5 p-4 bg-slate-700/50 rounded-lg border border-slate-600 max-h-48 overflow-y-auto">
        ...
        <div className="text-xs text-slate-400 leading-relaxed space-y-2">
          ...
          <p><strong className="text-slate-300">Data Retention:</strong> Your vetting data will be retained for a period of 12 months from your last active placement to enable continuous compliance monitoring. DBS certificate numbers are automatically purged 6 months after the recruitment decision, in accordance with the DBS Code of Practice. After 12 months of inactivity, your personal data will be anonymised, retaining only the compliance audit trail as required by CQC regulations and applicable employment law. You may request deletion of your data at any time through the GDPR Privacy Panel in your candidate portal, and it will be processed within 30 days (subject to legal retention requirements).</p>
          <p><strong className="text-slate-300">Your Rights:</strong> Under UK GDPR, you have the right to: access your data (Subject Access Request), request correction of inaccurate data, request deletion (right to be forgotten), restrict processing, data portability, object to processing, and to lodge a complaint with the ICO.</p>
          ...
          <p><strong className="text-slate-300">DBS Consent:</strong> By proceeding, you specifically consent to an Enhanced DBS check being carried out, which may include checks against the children and/or adults barred lists as required by the role. Where your agency requires candidate-supplied DBS, you authorise the agency and Viper AI to verify your DBS certificate via the DBS Update Service.</p>
          <p><strong className="text-slate-300">Continuous Monitoring:</strong> Where your agency subscribes to continuous monitoring, your compliance status (credential expiry, DBS status, registration status) will be checked periodically for the duration of your active placement. You will be notified of any status changes.</p>
        </div>
      </div>
      ...
      <div className="mb-4 p-4 bg-blue-500/10 border border-blue-500/20 rounded-lg">
        <label className="flex gap-3 cursor-pointer items-start">
          ...
          <span className="text-sm text-slate-300 leading-relaxed">
            <strong className="text-white">I confirm that:</strong> All information provided is accurate and complete. I have read and agree to the Privacy Policy and Terms of Service. I consent to the processing of my personal data for employment vetting purposes, including DBS checks, identity verification, and all other compliance checks listed above. I consent to the retention of my vetting data for up to 12 months for continuous compliance monitoring. I understand my rights under UK GDPR, including the right to withdraw consent at any time.
          </span>
        </label>
      </div>
